...
const mongourl = "mongodb+srv://admin123:admin21@cluster0.pvatv.mongodb.net/edurekinternship?retryWrites=true&w=majority"
let db;
...
app.get('/',function(req,res){
    res.send("Hi from express hiiiiii")
})
...
// second route (default)
app.get('/second',function(req,res){
    res.send("Hi to second URL")
})
...
app.listen(port,function(err){
  ...
  //restaurant?lcost=200&hcost=400
  //restaurant?city=3
  //restaurant?city=1&mealtype=2